...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-RightMeowTV/SDWebImage.framework"
  install_framework "Pods-RightMeowTV/SVProgressHUD.framework"
  install_framework "Pods-RightMeowTV/SnapKit.framework"
fi
