            ...
            for tweet in jsonDict! {
                ...
                if medias != nil {
                    ...
                    let entry = Entry(
                        ...
                        imgUrl: tweet["entities"]!!["media"]!![0]["media_url"] as! String,
            ...
            if error != nil {
                ...
                for var i = 0; i < items.count; ++i {
                    ...
                    if checkUrl.pathExtension!.lowercaseString == "gif" {
                        ...
                        var myUrl = originalurl.stringByReplacingOccurrencesOfString(".gif", withString: ".mp4", options: NSStringCompareOptions.LiteralSearch, range: nil)
//                        var url = NSURL(string: originalurl)
//                        var interimUrl = url?.path
//                        var correctUrl = interimUrl! + ".mpa"
                        ...
                        var originalurl = item["data"]["url"].stringValue
                        var myUrl = originalurl.stringByReplacingOccurrencesOfString(".gifv", withString: ".mp4", options: NSStringCompareOptions.LiteralSearch, range: nil)
